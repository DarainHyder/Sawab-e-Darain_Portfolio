...
const experiences = [
  {
    ...
    period: "7 April 2026 – 15 June 2026",
    duration: "~10 weeks",
    description: "Built scalable AI/ML data pipelines for social media management dashboards. Implemented ETL/ELT workflows and managed data quality assurance and schema validation for production-ready components.",
    current: false,
  },
  {
