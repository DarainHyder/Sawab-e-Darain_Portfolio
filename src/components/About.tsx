            ...
            <CardContent className="p-8">
              <div className="flex flex-wrap gap-3 justify-center">
                {[
                  ...
                  { name: "Hugging Face", logo: "huggingface", color: "bg-[#FFD21E]" },
                  { name: "NLTK", logo: "nltk", color: "bg-[#154F7D]" },
                  ...
                  { name: ".NET", logo: "dotnet", color: "bg-[#512BD4]" },
                  { name: "FastAPI", logo: "fastapi", color: "bg-[#009688]" },
                  { name: "Streamlit", logo: "streamlit", color: "bg-[#FF4B4B]" },
